...
<html lang="en">
    <head>
        ...
        <link rel="icon" href="images/telapak-kaki-kucing.png" type="image/x-icon">
        <title>Enha Petshop</title>
        ...
        <style>
            .hero-bg {
                background-image: url('https://plus.unsplash.com/premium_photo-1707353401897-da9ba223f807?q=80&w=870&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D');
    ...
    <body class="font-sans antialiased text-gray-900 dark:text-gray-100">
        <div class="min-h-screen bg-amber-100 dark:bg-amber-900">
                        ...
                        <div class="flex items-center">
                            <div class="shrink-0 flex items-center">
                                <a href="#" class="flex items-center">
                                    <span class="text-lg sm:text-2xl font-bold text-orange-600 dark:text-orange-400">
                                        Enha Petshop
                                    </span>
                                </a>
                            </div>
            ...
            <div class="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-4">
                <div class="bg-white dark:bg-amber-800 text-amber-800 dark:text-gray-200 rounded-lg shadow-xl overflow-hidden">
                    <!-- Slider Section -->
                    <div class="relative">
                        <div class="swiper h-48 sm:h-64 md:h-80 lg:h-96">
                    ...
                    <!-- Content Section -->
                    <div class="bg-white dark:bg-orange-400 p-4 sm:p-6 lg:p-8">
                        <h1 class="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-extrabold mb-4 leading-tight text-emerald-900 text-center">
                            Daftar GRATIS Jadi Member Enha Petshop!
                        </h1>
                        <p class="text-sm sm:text-base md:text-lg lg:text-xl mb-6 sm:mb-8 text-gray-100 text-center max-w-4xl mx-auto">
                        ...
                        <div class="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-4">
                            <a href="{{ route('register') }}" class="w-full sm:w-auto bg-orange-600 hover:bg-orange-700 text-white font-bold py-3 px-6 rounded-lg shadow-lg transition duration-300 transform hover:scale-105 text-center">
                                Daftar Sekarang!
                            </a>
                        </div>
                        @guest
                            <p class="mt-6 sm:mt-8 text-sm sm:text-base opacity-80 text-gray-200 text-center">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-4 sm:p-6 text-gray-900">
                            <h2 class="text-2xl sm:text-3xl text-white font-bold mb-6 sm:mb-8 text-center">Product dan Layanan</h2>
                            <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6">
                                
                                <!-- Shop -->
                                <div class="bg-white dark:bg-amber-900 rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 border border-orange-100 dark:border-amber-700 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 cursor-pointer group">
                                    <a href="{{ route('guest.shop') }}" class="block">
                                        <div class="flex flex-col items-center text-center space-y-2 sm:space-y-3">
                                            ...
                                            <h3 class="text-base sm:text-lg font-bold text-gray-800 dark:text-white group-hover:text-orange-500 transition-colors">Shop</h3>
                                            <p class="text-xs text-gray-500 dark:text-gray-400 hidden sm:block">Makanan & Aksesoris</p>
                                        </div>
                                    </a>
                                </div>

                                <!-- Grooming -->
                                <div class="bg-white dark:bg-amber-900 rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 border border-yellow-100 dark:border-amber-700 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 cursor-pointer group">
                                    <a href="{{ route('guest.grooming') }}" class="block">
                                        <div class="flex flex-col items-center text-center space-y-2 sm:space-y-3">
                                            ...
                                            <h3 class="text-base sm:text-lg font-bold text-gray-800 dark:text-white group-hover:text-yellow-500 transition-colors">Grooming</h3>
                                            <p class="text-xs text-gray-500 dark:text-gray-400 hidden sm:block">Perawatan Hewan</p>
                                        </div>
                                    </a>
                                </div>
                                ...
                                <!-- Clinic -->
                                <div class="bg-white dark:bg-amber-900 rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 border border-orange-100 dark:border-amber-700 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 cursor-pointer group">
                                    <a href="{{ route('guest.clinic') }}" class="block">
                                        <div class="flex flex-col items-center text-center space-y-2 sm:space-y-3">
                                            ...
                                            <h3 class="text-base sm:text-lg font-bold text-gray-800 dark:text-white group-hover:text-blue-500 transition-colors">Clinic</h3>
                                            <p class="text-xs text-gray-500 dark:text-gray-400 hidden sm:block">Kesehatan Hewan</p>
                                        </div>
                                    </a>
                                </div>
                                ...
                                <!-- Hotel -->
                                <div class="bg-white dark:bg-amber-900 rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 border border-yellow-100 dark:border-amber-700 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 cursor-pointer group">
                                    <a href="{{ route('guest.hotel') }}" class="block">
                                        <div class="flex flex-col items-center text-center space-y-2 sm:space-y-3">
                                            ...
                                            <h3 class="text-base sm:text-lg font-bold text-gray-800 dark:text-white group-hover:text-yellow-500 transition-colors">Hotel</h3>
                                            <p class="text-xs text-gray-500 dark:text-gray-400 hidden sm:block">Penitipan Hewan</p>
                                        </div>
                                    </a>
                                </div>
            ...
            <!-- Features Section -->
            <div class="py-12 sm:py-16 bg-white dark:bg-amber-800 text-amber-800 dark:text-gray-200">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <h2 class="text-2xl sm:text-3xl font-bold mb-6 sm:mb-8 text-center">Kenapa Memilih Enha Petshop?</h2>
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
                        
                        <div class="p-4 sm:p-6 bg-yellow-50 dark:bg-yellow-600 rounded-lg shadow-md">
                            <svg class="w-12 h-12 text-gray-500 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
                            <h3 class="text-lg sm:text-xl font-semibold mb-2 text-center">Layanan Profesional</h3>
                            <p class="text-gray-600 dark:text-gray-300 text-sm sm:text-base text-center">Tim ahli kami siap memberikan perawatan terbaik untuk hewan kesayangan Anda.</p>
                        </div>
                        
                        <div class="p-4 sm:p-6 bg-yellow-50 dark:bg-yellow-600 rounded-lg shadow-md">
                            <svg class="w-12 h-12 text-gray-500 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
                            <h3 class="text-lg sm:text-xl font-semibold mb-2 text-center">Produk Berkualitas</h3>
                            <p class="text-gray-600 dark:text-gray-300 text-sm sm:text-base text-center">Berbagai pilihan makanan, mainan, dan aksesori dari merek terkemuka.</p>
                        </div>
                        ...
                        <div class="p-4 sm:p-6 bg-yellow-50 dark:bg-yellow-600 rounded-lg shadow-md">
                            ...
                            <h3 class="text-lg sm:text-xl font-semibold mb-2 text-center">Rewards Menarik</h3>
                            <p class="text-gray-600 dark:text-gray-300 text-sm sm:text-base text-center">Dapatkan poin setiap transaksi dan tukarkan dengan hadiah istimewa.</p>
                        </div>
            ...
            <!-- Footer -->
            <footer class="bg-gray-800 dark:bg-gray-900 text-white py-6 sm:py-8 mt-auto">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <p class="text-sm sm:text-base">&copy; 2024 Enha Petshop. All rights reserved.</p>
                    <p class="text-xs sm:text-sm text-gray-400 mt-2">Dibuat dengan ❤️ untuk hewan kesayangan Anda.</p>
                </div>
            </footer>
        </div>
