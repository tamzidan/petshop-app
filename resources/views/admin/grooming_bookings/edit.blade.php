{{-- resources/views/admin/nama_fitur_baru/edit.blade.php --}}
...
<x-app-layout>
    <div class="py-12 bg-gray-50 dark:bg-gray-900 min-h-screen">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-lg sm:rounded-2xl border border-gray-100 dark:border-gray-700">
                ...
                <div class="bg-gradient-to-r from-orange-500 via-amber-500 to-yellow-400 p-6 text-white">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <h3 class="text-2xl font-bold mb-2">Edit Data Penitipan</h3>
                ...
                <div class="p-6">
                    {{-- Notifikasi (Sukses, Error, Validasi) tetap sama untuk konsistensi UX --}}
                    @if (session('success'))
                    ...
                    {{-- Ganti route ini ke route update fitur Anda --}}
                    <form action="{{ route('admin.grooming.update', $booking->id) }}" method="POST">
                        ...
                        <div class="grooming-details p-4 border border-dashed border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-700 text-gray-800 dark:text-gray-200 mt-6" id="groomingDetails" style="display: none;">
                            {{-- [DIUBAH] Warna teks harga --}}
                            <p class="text-sm font-medium">Harga Estimasi: <strong id="selectedPrice" class="text-orange-600 dark:text-orange-400 text-lg"></strong></p>
                        </div>
                        ...
                        <div class="mt-8 flex justify-end space-x-4">
                            {{-- Tombol Batal tetap abu-abu sebagai aksi sekunder --}}
    ...
    {{-- Script JavaScript tidak perlu diubah karena hanya mengatur logika, bukan style --}}
    <script>
